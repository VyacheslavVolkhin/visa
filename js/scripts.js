document.addEventListener("DOMContentLoaded", function() {
	...
	//slider tiles
	const swiperTiles = new Swiper('.slider-tiles .swiper', {
		loop: false,
		slidesPerView: 1,
		spaceBetween: 0,
		autoHeight: false,
		...
		autoplay: false,
		navigation: {
			nextEl: '.button-slider-tiles-next',
			prevEl: '.button-slider-tiles-prev',
		},
	...
	const swiperSliderReviews = new Swiper('.slider-reviews .swiper', {
		...
		autoplay: false,
		navigation: {
			nextEl: '.button-slider-reviews-next',
			prevEl: '.button-slider-reviews-prev',
		},
	...
	const swiperSliderMain = new Swiper('.slider-main .swiper', {
		...
		navigation: {
			nextEl: '.button-slider-main-next',
			prevEl: '.button-slider-main-prev',
		},
